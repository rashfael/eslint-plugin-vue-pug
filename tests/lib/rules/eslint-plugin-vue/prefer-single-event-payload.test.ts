// AUTOGENERATED FROM https://github.com/vuejs/eslint-plugin-vue/blob/3868a2d6e7b44037dd5aa04a7acdd857a0358a7b/tests/lib/rules/prefer-single-event-payload.test.ts
/**
 * @author Flo Edelmann
 * See LICENSE file in root directory for full license.
 */
import { RuleTester } from '../../../eslint-compat'
import rule from 'eslint-plugin-vue/dist/rules/prefer-single-event-payload'
...
const tsLanguageOptions = {
  ...
  parserOptions: { parser: tsParser , templateTokenizer: { pug: 'vue-eslint-parser-template-tokenizer-pug'}}
}
...
tester.run('prefer-single-event-payload', rule, {
  valid: [
    // Template - no payload
    {
      filename: 'test.vue',
      code: `
      <template lang="pug">div(@click="\$emit('change')")</template>`
    },
    // Template - single payload value
    {
      filename: 'test.vue',
      code: `
      <template lang="pug">div(@click="\$emit('change', value)")</template>`
    },
    // Template - single object payload
    {
      filename: 'test.vue',
      code: `
      <template lang="pug">div(@click="\$emit('change', { a, b })")</template>`
    },
    // <script setup> - defineEmits used in template with single object payload
    {
      filename: 'test.vue',
      code: `
       <template lang="pug">div(@click="emit('change', { a: 'foo', b: 'bar' })")</template>
  ...
  invalid: [
    // Template - multiple payloads
    {
      filename: 'test.vue',
      code: `
      <template lang="pug">div(@click="\$emit('change', value1, value2)")</template>`,
      errors: [
        {
          message:
    ...
    // Template - three payload args
    {
      filename: 'test.vue',
      code: `
      <template lang="pug">div(@click="\$emit('update', a, b, c)")</template>`,
      errors: [
        {
          message:
    ...
    // <script setup> - defineEmits used in template
    {
      filename: 'test.vue',
      code: `
       <template lang="pug">div(@click="emit('change', 'foo', 'bar')")</template>
       <script setup lang="ts">
       const emit = defineEmits<{
