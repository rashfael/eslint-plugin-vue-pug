// SKIP AUTOGENERATION
// AUTOGENERATED FROM https://github.com/vuejs/eslint-plugin-vue/blob/3868a2d6e7b44037dd5aa04a7acdd857a0358a7b/tests/lib/rules/sort-keys.test.ts
/**
 * @fileoverview Enforces sort-keys within components after the top level details
 * @author Loren Klingman
 */
import type { Linter } from 'eslint'
import rule from 'eslint-plugin-vue/dist/rules/sort-keys'
