// SKIP AUTOGENERATION
// Originally autogenerated from upstream's block-order.test.ts; the bundled
// plugin and processor imports were rewritten to target the eslint-plugin-vue
// package instead of upstream's local `dist` / `lib/processor` paths.
/**
 * @author Yosuke Ota
 */
import assert from 'node:assert'
import parserVue from 'vue-eslint-parser'
import rule from 'eslint-plugin-vue/dist/rules/block-order'
import { ESLint, RuleTester } from '../../../eslint-compat'
import pluginVue from 'eslint-plugin-vue'
import processor from 'eslint-plugin-vue/dist/processor'
