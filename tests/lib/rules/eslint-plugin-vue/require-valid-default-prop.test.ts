// SKIP AUTOGENERATION
// Originally autogenerated from upstream's require-valid-default-prop.test.ts;
// the RuleTester now sets a default ecmaVersion so cases that don't supply
// their own languageOptions still parse with a sensible default.
/**
 * @fileoverview Enforces props default values to be valid.
 * @author Armano
 */
import type { Linter } from 'eslint'
import rule from 'eslint-plugin-vue/dist/rules/require-valid-default-prop'
