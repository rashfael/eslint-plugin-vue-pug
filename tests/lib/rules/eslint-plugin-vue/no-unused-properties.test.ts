// SKIP AUTOGENERATION
// Originally autogenerated from upstream's no-unused-properties.test.ts; the
// cross-rule import for `no-unused-components` was rewritten to load from the
// eslint-plugin-vue package instead of upstream's relative `lib/rules/` path.
/**
...
import rule from 'eslint-plugin-vue/dist/rules/no-unused-properties'
import noUnusedComponents from 'eslint-plugin-vue/dist/rules/no-unused-components'
  ...
  valid: [
    // vuex getters
    {
      ...
      code: `
        ...
        <template lang="pug">| {{ baz() }}</template>
      `,
      options: allOptions
    },
    {
      ...
      code: `
        ...
        <template lang="pug">| {{ count }}</template>
      `
    },
    {
      filename: 'test.vue',
...
| {{ count2 }}
    ...
    // vuex mutations
    {
      ...
      code: `
        ...
        <template lang="pug">| {{ add() }}</template>
      `
    },
    {
      filename: 'test.vue',
...
| {{ foo.baz }}
    ...
    // props.prop in template
    {
      filename: 'test.vue',
      code: `
      <template lang="pug">| {{props}}</template>
      <script setup>
    ...
    },
    {
      filename: 'test.vue',
      code: `
      <template lang="pug">| {{props.a}}</template>
      <script setup>
    ...
    },
    {
      filename: 'test.vue',
      code: `
      <template lang="pug">| {{foo.a}}</template>
      <script setup>
