// SKIP AUTOGENERATION
// Originally autogenerated from upstream's require-prop-types.test.ts;
// the RuleTester now sets a default ecmaVersion so cases that override only
// `languageOptions.parser` (without supplying their own ecmaVersion) still
// parse with the vue-eslint-parser.
/**
 * @fileoverview Prop definitions should be detailed
 * @author Armano
 */
import rule from 'eslint-plugin-vue/dist/rules/require-prop-types'
