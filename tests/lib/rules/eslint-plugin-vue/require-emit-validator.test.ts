// SKIP AUTOGENERATION
// AUTOGENERATED FROM https://github.com/vuejs/eslint-plugin-vue/blob/3868a2d6e7b44037dd5aa04a7acdd857a0358a7b/tests/lib/rules/require-emit-validator.test.ts
/**
 * @fileoverview Emit definitions should be detailed
 * @author Pig Fang
 */
import rule from 'eslint-plugin-vue/dist/rules/require-emit-validator'
