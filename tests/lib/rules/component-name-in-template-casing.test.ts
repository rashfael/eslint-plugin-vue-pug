...
import rule from '../../../lib/rules/component-name-in-template-casing.ts'
...
foo-bar-baz-qux
    ...
    {
      // built-in components (behave the same way as other components, except
      // `<component>` which eslint-plugin-vue >= 10.9 treats as a Vue built-in
      // element and skips).
      code: `
        <template lang="pug">
component
