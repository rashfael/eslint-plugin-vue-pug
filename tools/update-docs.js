...
- [Rule source](https://github.com/rashfael/eslint-plugin-vue-pug/blob/main/lib/rules/${name}.js)
- [Test source](https://github.com/rashfael/eslint-plugin-vue-pug/blob/main/tests/lib/rules/${name}.js)
${
